...
import { Link } from "react-router-dom";
import { Phone, Mail, MapPin, Instagram, Heart } from "lucide-react"; // Added Heart icon
import logo from "@/assets/logo.jpeg";
  ...
  return (
    <footer className="bg-secondary text-secondary-foreground">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="mt-10 pt-6 border-t border-secondary-foreground/20 flex flex-col sm:row items-center justify-between gap-4 text-center sm:text-left">
          <div className="space-y-2">
            <p className="text-xs text-secondary-foreground/50">
              © {new Date().getFullYear()} Shannie's Kitchen. All rights reserved.
            </p>
            
            {/* Added StaffArc Attribution */}
            <div className="flex justify-center sm:justify-start items-center gap-1 text-sm">
